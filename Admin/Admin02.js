...
function countTotalItems() {
    const containers = ['resContainer5', 'resContainer6', 'resContainer7', 'resContainer8', 'resContainer9', 'resContainer10',];
...
function autoCountTo(target) {
    ...
    const countingInterval = setInterval(() => {
        ...
        document.getElementById('jobAppCount').textContent = `${count}`;
    }, incrementTime);
}
