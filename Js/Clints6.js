...
const resContainer = document.getElementById('resContainer6');

// Function to fetch and display all data
function fetchAndDisplayData() {
    const dbRef = ref(db, "resContainer6");
...
window.acceptRequest = function (id) {
    ...
    const dbRef = ref(db, `resContainer6/${id}`);
